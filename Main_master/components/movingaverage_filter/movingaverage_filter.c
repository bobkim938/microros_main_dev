...
//     if (newDataPointsCount < MAX_DATA_POINTS)   dataPointsCount = newDataPointsCount;
//     else dataPointsCount = MAX_DATA_POINTS;
//     for (i = 0; i < dataPointsCount; i++) values[i] = 0; // fill the array with 0's
// }
...
//     for (i = 0; i < dataPointsCount; i++) out += values[i]; 
